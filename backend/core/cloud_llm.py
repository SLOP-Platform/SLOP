...
PROVIDERS: dict[str, dict[str, Any]] = {
    ...
    "opencode": {
        ...
        "notes": "OpenAI-compatible hosted API.",
    },
    "commandcode": {
        "label": "commandcode",
        "base_url": "https://api.commandcode.com/v1",
        "env_key": "COMMANDCODE_API_KEY",
        "default_model": "commandcode-auto",
        "free_tier": False,
        "input_cost_per_1m": 0.0,
        "output_cost_per_1m": 0.0,
        "privacy": "us",
        "signup_url": "https://commandcode.com",
        "notes": "OpenAI-compatible hosted API.",
    },
    "cline_pass": {
        "label": "Cline Pass",
        "base_url": "https://api.cline.bot/v1",
        "env_key": "CLINE_PASS_API_KEY",
        "default_model": "cline-pass-auto",
        "free_tier": False,
        "input_cost_per_1m": 0.0,
        "output_cost_per_1m": 0.0,
        "privacy": "us",
    ...
    "neuralwatt": {
        ...
        "default_model": "neuralwatt-auto",
        "free_tier": False,
        "input_cost_per_1m": 0.0,
        "output_cost_per_1m": 0.0,
        "privacy": "us",
        "signup_url": "https://neuralwatt.com",
        "notes": "OpenAI-compatible hosted API.",
    },
    "deepseek": {
        "label": "DeepSeek",
        ...
        "notes": "Extremely cheap. DeepSeek-V3 and R1 models. China infrastructure.",
    },
    "together": {
        "label": "Together.ai",
        ...
        "notes": "200+ open-source models. Fast dedicated infrastructure.",
    },
    "deepinfra": {
        "label": "Deep Infra",
        ...
        "notes": "Cheap open-source inference. Good Llama/Mistral pricing.",
    },
    "synthetic_new": {
        "label": "synthetic.new",
        "base_url": "https://api.synthetic.new/v1",
        "env_key": "SYNTHETIC_NEW_API_KEY",
        "default_model": "synthetic-auto",
        "free_tier": False,
        "input_cost_per_1m": 0.0,
        "output_cost_per_1m": 0.0,
        "privacy": "us",
    ...
    "trae": {
        ...
        "env_key": "TRAE_API_KEY",
        "default_model": "trae-auto",
        "free_tier": False,
        "input_cost_per_1m": 0.0,
        "output_cost_per_1m": 0.0,
        "privacy": "us",
        "signup_url": "https://trae.ai",
        "notes": "OpenAI-compatible hosted API.",
    },
}
